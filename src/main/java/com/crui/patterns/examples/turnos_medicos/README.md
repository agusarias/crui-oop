...
- <p>Implementar uno o más de estos patrones adicionales para mejorar el código.
  */
  ...
  \***\* Primero, antes de utilizar los patrones de diseños probables, voy a \*\*** refactorizar el codigo para que quede mas limpiio y ordenado. \***\* STRATEGY: Implementando este patron en la logica de calcular precio y \*\*** metodos de pago.
  \*\*\*\* DECORATOR: en los turnos
